"""IDA Pro MCP installation utilities.

Install the IDA plugin and MCP client configuration.
"""
...
def install_mcp_servers(*, uninstall=False, quiet=False):
    """Install or uninstall MCP server configuration."""
...
def install_ida_plugin(*, uninstall=False, quiet=False, allow_ida_free=False):
    """Install or uninstall the IDA plugin."""
    if sys.platform == "win32":
